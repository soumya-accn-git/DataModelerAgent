...
## BRD-SPECIFIC RULES — MerchandisingAnalysis
*Auto-generated by Step 1b from the uploaded BRD*

### Expected Dimension entities
- `CustomerDimension`
- `GeographyDimension`
- `ProductCategory`
- `OrganizationDimension`

### Expected Fact entities
- `SaleFact`
- `MarkdownFact`

### Expected Reference entities

### BRD-specific forbidden patterns (MUST NOT become entities)
- `CustomerAnalysis`
...
### Key metrics (attributes of Fact entities — NOT standalone entities)
- `TotalRevenue`
- `UnitsSold`
- `MarkdownAmount`
- `MarkdownQuantity`
- `RegularPriceAmount`
- `PromotionPriceAmount`
- `ClearancePriceAmount`

### Filter/Prompt → Dimension mappings (Rule R6 — BRD specific)
- `RegionFilter` → `GeographyDimension`
