...
from src.pipeline.step1_parser            import parse_docx
from src.pipeline.step1b_ontology_builder import build_ontology_from_brd
from src.pipeline.step2_graphrag          import run_graphrag_pipeline, GraphRAGError
from src.tools.result_store            import save_cdm
from config import (
...
from src.pipeline.step2_entities          import extract_entities
from src.pipeline.step3_relationships      import detect_relationships
...
def run_pipeline(
    ...
    graph_nodes      = graphrag_result.get("graph_nodes", [])
    graph_rels       = graphrag_result.get("graph_rels",  [])
    ...
    _start(4)
    _log("Detecting relationships — LLM full-doc scan + deterministic GraphRAG merge…")
